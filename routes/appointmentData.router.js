...
import {createAppointmentDataDtos, updateAppointmentDataDtos, findOrDeleteRequireDtos} from '../dtos/appointmentData.dto.js'
...
router.get('/', async (req, res, next)=>{
    try {
        const allDates = await appointmentDataController.getAll()
